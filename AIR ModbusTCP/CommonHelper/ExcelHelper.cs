...
namespace CommonHelper
{
    ...
    public class ExcelHelper
    {
        ...
        /// <param name="dir">list，Excel字典集合</param>
        ...
        /// 读取Excel文件某一索引sheet的内容到List集合
        /// </summary>
        /// <typeparam name="T">Sheet内容的对象</typeparam>
        /// <param name="strFileName">文件路径</param>
        /// <param name="dir">List和Excel列名集合</param>
        /// <param name="SheetIndex">表页索引</param>
        /// <param name="HeaderRowIndex">列名所在行号，-1表示没有列名</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// DataGridView导出到Excel（新增，替代，添加）
        /// </summary>
        /// <param name="filePath">文件路径</param>
        /// <param name="dataGridView">表格控件</param>
        /// <param name="isAppend">判断是否添加</param>
        /// <returns></returns>
